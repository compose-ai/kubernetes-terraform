...
module "node_pool_compose" {
  ...
  initial_node_count = var.initial_node_count_compose
  min_node_count     = var.min_node_count_compose
  max_node_count     = var.max_node_count_compose
  ...
  disk_type    = var.disk_type
  image_type   = var.image_type
  machine_type = var.machine_type_compose
